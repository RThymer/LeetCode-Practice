public class LongestPalindrome {
    public static String longestPalindrome(String s) {
        ...
        if(oddFlag == 0) resultString.append(s.substring(maxIndex - (maxLength - 1) / 2, maxIndex + (maxLength - 1) / 2 + 1));
        else resultString.append(s.substring(maxIndex - (maxLength - 2) / 2, maxIndex + (maxLength - 2) / 2 + 2));
